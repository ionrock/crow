...
mod tests {
    ...
    // -----------------------------------------------------------------------
    // build_author_prompt() comprehensive tests (CROW-26)
    // -----------------------------------------------------------------------
    ...
    fn author_prompt_no_threads_still_has_task_instructions() {
        ...
        assert!(!prompt.contains("Unresolved Review Comments — Action Required"));
    }
    ...
    fn author_prompt_multiple_unresolved_threads_all_shown_with_comments_and_diff_hunks() {
        ...
        assert!(prompt.contains("Unresolved Review Comments — Action Required (2)"));
    ...
    fn author_prompt_mixed_resolved_unresolved_only_unresolved_shown() {
        ...
        assert!(prompt.contains("Unresolved Review Comments — Action Required (1)"));
    ...
    // -----------------------------------------------------------------------
    // build_reviewer_prompt() comprehensive tests (CROW-26)
    // -----------------------------------------------------------------------
    ...
    fn reviewer_prompt_with_existing_threads_shown_with_do_not_repeat_instruction() {
        ...
        assert!(prompt.contains("Existing Review Comments (1)"));
        assert!(prompt.contains("Do NOT repeat them"));
    ...
    fn format_line_label_single_line() {
        ...
        assert_eq!(format_thread_line_label(&thread), "L42");
    }
    ...
    fn format_line_label_line_range() {
        ...
        assert_eq!(format_thread_line_label(&thread), "L15-20");
    }
    ...
    fn format_line_label_no_line() {
        ...
        assert_eq!(format_thread_line_label(&thread), "L?");
    }
